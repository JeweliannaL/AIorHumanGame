...
var winsource = document.getElementById('winsource');
var realsource = document.getElementById('realsource');
var nerds = document.getElementById('nerds');
var retrybtn = document.getElementById('retrybtn');
var moreinfobtn = document.getElementById('moreinfobtn');
var thxbox = document.getElementById('thxbox');
var thxboxinfo = document.getElementById('thxboxinfo');
var interest = document.getElementById('interest');

mainsource.style.visibility = 'hidden';
realsource.style.visibility = 'hidden';
winsource.style.visibility = 'hidden';
nerds.style.visibility = 'hidden';
moreinfobtn.style.visibility = 'hidden';
retrybtn.style.visibility = 'hidden';
thxbox.style.visibility = 'hidden';
thxboxinfo.style.visibility = 'hidden';
...
correctbox.style.visibility = 'hidden';
                 ...
                 //
                    ...
                    continuebtn.addEventListener('click', () => {
                      moreinfobtn.style.visibility = 'visible';
                      retrybtn.style.visibility = 'visible';
                      thxbox.style.visibility = 'visible';
                      thxboxinfo.style.visibility = 'visible';
                    ...
                    moreinfobtn.onclick = function () {
                      ...
                      infobox.style.visibility = 'visible';
                      info.style.visibility = 'visible';
                      mainsource.style.visibility = 'visible';
                      realsource.style.visibility = 'visible';
                      winsource.style.visibility = 'visible';
                      nerds.style.visibility = 'visible';
                  ...
                  // Event listener for retrybtn click
